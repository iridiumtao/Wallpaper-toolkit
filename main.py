...
def image_process(path):
    ...
    # foreground = blur.image_edgy_blur(image=foreground)
    mix = image_processor.mix_image(name=foreground.filename, foreground=foreground, background=blurred_image, save=False)
